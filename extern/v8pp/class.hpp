...
public:
	...
	template<typename T>
	typename boost::enable_if<boost::is_polymorphic<T>, v8::Local<v8::Object>>::type
	find_object(v8::Isolate* isolate, T const* object)
	{
		return find_obj(isolate, dynamic_cast<void const*>(object));
	}

	template<typename T>
	typename boost::disable_if<boost::is_polymorphic<T>, v8::Local<v8::Object>>::type
	find_object(v8::Isolate* isolate, T const* object)
	{
		return find_obj(isolate, object);
	}

private:
	v8::Local<v8::Object> find_obj(v8::Isolate* isolate, void const* object)
	{
		...
		{
			result = (*it)->find_obj(isolate, object);
		}
		return result;
	}
...
public:
	...
	static void unreference_external(v8::Isolate* isolate, T* ext)
	{
		return class_singleton::instance(isolate).remove_object(isolate, ext,
			static_cast<void (*)(v8::Isolate*, T*)>(nullptr));
	}
